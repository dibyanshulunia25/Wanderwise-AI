        ...
        <div>
            ...
            <div className="flex flex-col items-start justify-start gap-4 mt-4 ">
                {suggestions.map((suggestion, index) => (
                    <div onClick={() => onSelectOption(suggestion.title)} key={index} className="flex items-center gap-2 border-2 border-primary/20 shadow-lg hover:cursor-pointer hover:bg-primary/40 rounded-full p-2">
                        {suggestion.icon}
